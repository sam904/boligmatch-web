...
export default function AdminToast({
  ...
  return (
    ...
    >
      <div
        className={`pointer-events-auto flex items-center justify-between rounded-2xl px-4 py-2.5 shadow-lg ${baseColors}`}
      >
        <div className="flex items-center gap-3">
          <span className="inline-flex items-center justify-center bg-transparent">
            {type === "success" && (
              ...
              >
                <g clip-path="url(#clip0_405_4112)">
                  <path
            ...
            {type === "info" && (
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_405_4138)">
                  <path
                    d="M17.54 34.58C26.9509 34.58 34.58 26.9509 34.58 17.54C34.58 8.12907 26.9509 0.5 17.54 0.5C8.12907 0.5 0.5 8.12907 0.5 17.54C0.5 26.9509 8.12907 34.58 17.54 34.58Z"
                    stroke="white"
                    stroke-miterlimit="10"
            ...
            {type === "error" && (
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_405_4142)">
                  <path
                    d="M17.54 34.58C26.9509 34.58 34.58 26.9509 34.58 17.54C34.58 8.12907 26.9509 0.5 17.54 0.5C8.12907 0.5 0.5 8.12907 0.5 17.54C0.5 26.9509 8.12907 34.58 17.54 34.58Z"
                    stroke="white"
                    stroke-miterlimit="10"
