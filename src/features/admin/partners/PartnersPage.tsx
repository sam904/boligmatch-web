...
export default function PartnersPage() {
  ...
  useEffect(() => {
    if (editingPartner && showForm) {
      const formData: PartnerFormData = {
        ...
        parDoclst: editingPartner.parDoclst && editingPartner.parDoclst.length > 0 
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <input 
                  ...
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
                />
                <label htmlFor={`doc-isActive-${index}`} className="text-sm font-medium text-gray-700">
                  Active
                </label>
              </div>
      ...
      {documentFields.some((field, index) => watch(`parDoclst.${index}.documentUrl`)) && (
