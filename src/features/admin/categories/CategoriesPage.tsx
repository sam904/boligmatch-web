      ...
      <div className="bg-white rounded-lg shadow p-4 mb-4">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm text-white font-medium rounded-lg shadow hover:shadow-md transition-all hover:opacity-90 bg-brand-gradient"
          >
