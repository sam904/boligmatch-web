...
export default function SubCategoriesPage() {
  ...
  }, [editingSubCategory, activeCategories.length, reset]);
...
//   } = useQuery({
//     queryKey: ['categories-all'],
//     queryFn: () => categoryService.getAll(true), // includeInActive = true to get all
...
//     }
//   }
// }, [editingSubCategory, activeCategories.length, reset]); // Only depend on activeCategories.length instead of the whole array
...
//   // Show warning if no active categories available
//   useEffect(() => {
//     if (!categoriesLoading && activeCategories.length === 0 && isModalOpen) {
//       toast.warning('No active categories available. Please create an active category first.');
//     }
//   }, [categoriesLoading, activeCategories.length, isModalOpen]);
...
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
//                 </svg>
//                 <span className="text-sm font-medium">No Active Categories</span>
//               </div>
//               <p className="text-yellow-700 text-sm mt-1">
//                 You need to create an active category before adding subcategories.
//               </p>
