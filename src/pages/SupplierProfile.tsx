...
//         showContactErrorToast(
//           t("supplierProfile.toast.contactSubjectRequired")
//         );
//         return;
//       }
//       if (!contactBody.trim()) {
...
//       if (!recommendEmail) {
//         showRecommendationErrorToast(
//           t("supplierProfile.toast.recommendEmailMissing")
//         );
//         return;
//       }
  ...
  return (
    <>
      <div className="md:h-[100vh]">
        ...
        <div className="absolute inset-0 z-50  group pointer-events-none group hover:pointer-events-auto">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-4">
              <div className="flex items-center gap-8">
                ...
                <button
                  ...
                  className="pointer-events-auto text-white hover:scale-110 transition-transform"
                  title="Skip backward 10 seconds"
                >
                  <FaBackward className="h-10 w-10 cursor-pointer" />
                  <span className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 text-xs bg-black/70 px-2 py-1 rounded text-white">
                    10s
                  </span>
                </button>
                ...
                <button
                  ...
                  className="pointer-events-auto text-white hover:scale-110 transition-transform"
                >
                  <FaPlayCircle className="h-14 w-14 cursor-pointer" />
                </button>
                ...
                >
                  <FaForward className="h-10 w-10 cursor-pointer" />
                  <span className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 text-xs bg-black/70 px-2 py-1 rounded text-white">
                    10s
                  </span>
                </button>
              ...
              {duration > 0 && (
                <div className="text-white text-sm bg-black/50 px-3 py-1 rounded-md mt-2">
          ...
          {/* Show pause and skip buttons when video IS playing */}
          {isVideoPlaying && (
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-4">
              <div className="flex items-center gap-8">
                {/* Backward button */}
                ...
                <button
                  ...
                  className="pointer-events-auto text-white hover:scale-110 transition-transform"
                >
                  <FaPauseCircle className="h-14 w-14 cursor-pointer" />
                </button>
