...
const SupplierProfile = () => {
  ...
  "
    ...
    "
              ...
              <div className={`${!isPartner && 'bg-[#01351f] md:bg-[#01351f] '} md:bg-[#01351f] bg-[linear-gradient(180deg,rgba(1,53,31,0)_0%,#01351F_100%)] w-full ${isPartner ? (partnerData?.videoUrl ? "pt-[80px]" : "pt-[66px]") : "pt-[62px]"} md:mt-[0px]`}>
