...
const SupplierProfile = () => {
  ...
  const handlePause = () => setIsVideoPlaying(true); // Keep true when paused
...
// // Define validation schemas with explicit error messages
// const createSchemas = (t: (key: string) => string) => ({
//   contactSchema: z.object({
//     subject: z.string()
//       .min(1, { message: t("validation.subjectRequired") || "Subject is required" })
//       .max(100, { message: t("validation.subjectTooLong") || "Subject cannot exceed 100 characters" }),
//     body: z.string()
//       .min(1, { message: t("validation.messageRequired") || "Message is required" })
//       .max(1000, { message: t("validation.messageTooLong") || "Message cannot exceed 1000 characters" }),
//   }),
//   recommendationSchema: z.object({
//     email: z.string()
//       .min(1, { message: t("validation.emailRequired") || "Email is required" })
//       .email({ message: t("validation.invalidEmail") || "Invalid email address" }),
//     comment: z.string()
//       .max(500, { message: t("validation.commentTooLong") || "Comment cannot exceed 500 characters" })
//       .optional(),
//   }),
// });
...
//   const { contactSchema, recommendationSchema } = schemas;

//   // React Hook Form for contact modal
//   const {
//     register: registerContact,
//     handleSubmit: handleSubmitContact,
//     formState: { errors: contactErrors, isValid: isContactValid, isSubmitted: isContactSubmitted },
//     reset: resetContact,
...
//   // Watch contact form fields for real-time validation
//   const contactSubject = watchContact("subject");
//   const contactBody = watchContact("body");

//   // React Hook Form for recommendation modal
//   const {
//     register: registerRecommendation,
//     handleSubmit: handleSubmitRecommendation,
//     formState: { errors: recommendationErrors, isValid: isRecommendationValid, isSubmitted: isRecommendationSubmitted },
...
//   // Watch recommendation form fields for real-time validation
//   const recommendationEmail = watchRecommendation("email");
//   const recommendationComment = watchRecommendation("comment");

//   // Helper function to get error messages
//   const getErrorMessage = (error: any, fieldName: string): string => {
//     if (!error) return "";
...
//     // Fallback messages based on field name
//     const fallbackMessages: Record<string, string> = {
//       subject: t("validation.subjectRequired") || "Subject is required",
//       body: t("validation.messageRequired") || "Message is required",
//       email: t("validation.emailRequired") || "Email is required",
//       comment: t("validation.commentTooLong") || "Comment is too long",
//     };
    
//     return fallbackMessages[fieldName] || "Invalid input";
//   };

//   // Validate contact form on field changes
//   useEffect(() => {
//     if (activeModal === "contact") {
//       triggerContact();
//     }
//   }, [contactSubject, contactBody, activeModal]);

//   // Validate recommendation form on field changes
//   useEffect(() => {
//     if (activeModal === "recommend") {
//       triggerRecommendation();
//     }
//   }, [recommendationEmail, recommendationComment, activeModal]);
...
//       const isValid = await triggerContact();
//       if (!isValid) {
...
//       const targetId = getCurrentPartnerId();
//       if (!targetId) {
//         showFavouriteErrorToast(t("supplierProfile.contactModal.partnerNotFound"));
//         setIsSubmitting(false);
//         return;
//       }
...
//       if (!senderId) {
//         showFavouriteErrorToast(t("supplierProfile.contactModal.userNotFound"));
//         setIsSubmitting(false);
//         return;
//       }
...
//       // Show success toast
//       showFavouriteSuccessToast(t("supplierProfile.contactModal.success"));
...
//     } catch (error) {
//       console.error("Error sending message:", error);
//       showFavouriteErrorToast(t("supplierProfile.contactModal.sendError"));
//       setIsSubmitting(false);
//     }
//   };
...
//     try {
//       // Validate all fields before submission
//       const isValid = await triggerRecommendation();
//       if (!isValid) {
//         console.log("Recommendation form validation failed");
//         return;
//       }
...
//       const targetId = getCurrentPartnerId();
//       if (!targetId) {
//         showFavouriteErrorToast(t("supplierProfile.recommendModal.partnerNotFound"));
//         setIsSubmitting(false);
//         return;
//       }
...
//       if (!userId) {
//         showFavouriteErrorToast(t("supplierProfile.recommendModal.userNotFound"));
//         setIsSubmitting(false);
//         return;
//       }
...
//     } catch (error) {
//       console.error("Error sending recommendation:", error);
//       showFavouriteErrorToast(t("supplierProfile.recommendModal.sendError"));
//       setIsSubmitting(false);
//     }
//   };
...
//               {modalRendered === "recommend" && (
//                 <form onSubmit={handleSubmitRecommendation(handleSendRecommendation)}>
//                   <div className="flex flex-col items-stretch">
//                     <div className="flex justify-center mb-4">
//                       <img
//                         src={shareModel}
...
//                     <input
//                       type="email"
//                       placeholder={t("supplierProfile.recommendModal.emailPlaceholder") || "Enter email"}
//                       className={`mb-1 w-full rounded-[10px] bg-white h-9 px-3 outline-none border ${
//                         recommendationErrors.email ? "border-2 border-red-500" : "border-gray-300"
//                       }`}
//                       {...registerRecommendation("email")}
//                       disabled={isSubmitting}
//                     />
//                     {recommendationErrors.email && (
//                       <p className="text-red-500 text-xs mb-2 mt-1 animate-pulse">
//                         {getErrorMessage(recommendationErrors.email, "email")}
//                       </p>
//                     )}
...
//                     </label>
//                     <textarea
//                       placeholder={t("supplierProfile.recommendModal.commentPlaceholder") || "Enter comment (optional)"}
//                       className={`w-full rounded-[10px] bg-white h-28 px-3 py-2 outline-none resize-none border ${
//                         recommendationErrors.comment ? "border-2 border-red-500" : "border-gray-300"
//                       }`}
...
//                       <p className="text-red-500 text-xs mb-2 mt-1 animate-pulse">
//                         {getErrorMessage(recommendationErrors.comment, "comment")}
//                       </p>
//                     )}
...
//                       <button
//                         type="submit"
//                         disabled={!isRecommendationValid || isSubmitting}
//                         className={`min-w-[120px] h-10 text-white font-semibold rounded-lg transition-colors ${
//                           !isRecommendationValid || isSubmitting
//                             ? "bg-gray-400 cursor-not-allowed"
//                             : "bg-[#91C73D] hover:bg-[#7fb02f] cursor-pointer"
//                         }`}
//                       >
//                         {isSubmitting 
...
//                     {/* Validation summary */}
//                     {isRecommendationSubmitted && !isRecommendationValid && (
//                       <div className="mt-2 p-2 bg-red-50 border border-red-200 rounded text-xs text-red-600">
//                         {t("validation.formContainsErrors") || "Please fix the errors above before submitting."}
//                       </div>
//                     )}
//                   </div>
//                 </form>
...
//               {modalRendered === "contact" && (
//                 <form onSubmit={handleSubmitContact(handleSendConversation)}>
//                   <div className="flex flex-col items-stretch z-10">
//                     <div className="flex justify-center mb-4">
//                       <img
//                         src={chatModel}
...
//                       type="text"
//                       className={`mb-1 w-full rounded-[10px] bg-white h-9 px-3 outline-none border ${
//                         contactErrors.subject ? "border-2 border-red-500" : "border-gray-300"
//                       }`}
...
//                       <p className="text-red-500 text-xs mb-2 mt-1 animate-pulse">
//                         {getErrorMessage(contactErrors.subject, "subject")}
//                       </p>
//                     )}
...
//                     <textarea
//                       className={`w-full rounded-[10px] bg-white h-28 px-3 py-2 outline-none resize-none border ${
//                         contactErrors.body ? "border-2 border-red-500" : "border-gray-300"
//                       }`}
...
//                     {contactErrors.body && (
//                       <p className="text-red-500 text-xs mb-2 mt-1 animate-pulse">
//                         {getErrorMessage(contactErrors.body, "body")}
//                       </p>
//                     )}
...
//                     {/* Validation summary */}
//                     {isContactSubmitted && !isContactValid && (
//                       <div className="mt-2 p-2 bg-red-50 border border-red-200 rounded text-xs text-red-600 mb-4">
//                         {t("validation.formContainsErrors") || "Please fix the errors above before submitting."}
//                       </div>
//                     )}
