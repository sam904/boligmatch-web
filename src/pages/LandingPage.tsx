...
export default function LandingPage() {
  ...
  return (
    <div className="relative bg-[#01351f]">
      {/* Banner Image Section - Exact Figma Layout */}
      <div 
      ...
      >
        ...
        <div className="md:hidden absolute inset-0 bg-[url('/src/assets/userImages/mobile-landingImg.png')] bg-cover bg-center" />
        ...
        {/* Left side icons */}
        <div className="absolute md:top-26 top-28 lg:left-30 left-0 flex max-w-6xl mx-auto md:px-12 px-8 justify-between mt-0">
          <div>
            <div className="md:w-[165px] w-[70px] flex justify-end">
              <img
                src={landingPageIcons}
        ...
        {/* Sign Up Button positioned at bottom of banner */}
        <div className="flex justify-center absolute bottom-8 md:left-1/2 left-1/2 transform -translate-x-1/2">
          <button
            onClick={() => setShowSignUpModal(true)}
            className="bg-[#91C73D] rounded-lg md:text-[18px] text-[16px] cursor-pointer px-6 font-semibold md:py-2.5 py-2 text-white hover:bg-[#7fb32d] transition-colors figtree z-20"
          >
            {t("landing.signUpButton")}
          </button>
        </div>
      ...
      {/* Text content BELOW the banner image */}
      <div className="bg-[#01351f] pt-8 md:pt-12 pb-8">
        <h1 className="md:text-[76px] text-[40px] text-white leading-[66px] text-center rosting-script font-[400]">
          {t("landing.mainTitle")}
        </h1>
        <h2 className="text-white md:text-[60px] text-[40px] md:leading-[66px] leading-[48px] tracking-[0%] text-center max-w-4xl md:mx-auto mx-8 md:py-1 py-0 px-4 font-[800] plus-jakarta-sans">
