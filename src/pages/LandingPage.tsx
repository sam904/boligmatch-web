...
export default function LandingPage() {
  ...
  return (
    <>
        <div className="
         md:h-[100vh] h-[50vh] bg-cover bg-center bg-no-repeat
         bg-[url('/src/assets/userImages/home_pageImg.png')] 
        ">
          <UserHeader showBackButton={false} />
          <div className="h-[calc(100%-64px)] flex flex-col justify-end items-center ">
            <div className={`w-full flex justify-center ${isMobile ? 'bg-gradient-to-b from-[rgba(1,53,31,0)] to-[#01351F] to-98%' : ''}`}>
               <button
         ...
         <div className="bg-[#01351f]">
          <p className="w-full text-[#FFFFFF] max-w-7xl text-center md:text-[18px] text-[13px] mx-auto py-4 px-4 plus-jakarta-sans font-[300] tracking-[-0.4px]">
            <Trans
         ...
         {isMobile &&
        <div className="bg-[#01351f]">
          <h1 className="text-[40px] bg-gradient-to-b from-[rgba(1,53,31,0)] to-[#01351F] to-98%   w-full text-white  text-center rosting-script font-[400] px-4">
                {(() => {
                  const title = t("landing.mainTitle");
                  const [firstWord, ...rest] = title.split(" ");
              ...
              <div className="bg-gradient-to-b from-[rgba(1,53,31,0)] to-[#01351F] to-0% w-full">
                <h2 className="text-white text-[40px]  leading-[50px]  max-w-4xl tracking-[0%] text-center  md:mx-auto mx-8 pb-3 px-4 font-[800] plus-jakarta-sans">
                  {t("landing.subtitle")}
                </h2>
              </div>
          <p className="text-[#FFFFFF] text-center text-[13px]   py-2 px-4 plus-jakarta-sans font-[300] tracking-[-0.4px]">
            <Trans
              i18nKey="landing.description"
              components={{
                bold: <span className="font-semibold" />,
      ...
      <ServiceCarousel />
       <div className="bg-[#01351f] py-7 ">
        <h1 className="md:text-[64px] text-[36px] md:leading-[66px] leading-[42px] text-white text-center max-w-[350px] md:max-w-[845px] mx-auto font-[800] plus-jakarta-sans">
