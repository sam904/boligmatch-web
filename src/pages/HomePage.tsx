        ...
        <div className="max-w-6xl mx-auto px-6 py-16 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 mx-auto" style={{ backgroundColor: 'var(--color-primary-light)' }}>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 mx-auto" style={{ backgroundColor: 'var(--color-secondary-light)' }}>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            <div className="rounded-2xl p-8 text-white bg-brand-gradient">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-white opacity-90 mb-6 max-w-2xl">{t('home.adminDashboardDesc')}</p>
                  <Link 
                    to="/admin" 
            ...
            <div className="rounded-2xl p-8 text-white bg-brand-gradient">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-white opacity-90 max-w-2xl">{t('home.partnerDashboardDesc')}</p>
                </div>
                <div className="hidden md:block">
                  <svg className="w-32 h-32 text-white opacity-30" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <div className="text-3xl font-bold mb-2" style={{ color: 'var(--color-secondary)' }}>100%</div>
              <p className="text-gray-600">Secure platform</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-6">
              <div className="text-3xl font-bold mb-2" style={{ color: 'var(--color-primary)' }}>Fast</div>
