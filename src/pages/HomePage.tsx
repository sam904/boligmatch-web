        ...
        <div className="max-w-6xl mx-auto px-6 py-16 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">{t('home.easyManagement')}</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">{t('home.secureAccess')}</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">{t('home.multiLanguage')}</h3>
