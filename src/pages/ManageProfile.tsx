          ...
          <form
            ...
            onSubmit={async (e) => {
              ...
              if (middleName.trim() && !isValidName(middleName)) {
                showSignupErrorToast(
                  t("manageProfile.toast.middleNameInvalid")
                );
                return;
              }
              ...
              try {
                ...
                showSignupSuccessToast(
                  t("manageProfile.toast.profileUpdateSuccess")
                );
              } catch (err) {
                console.error("Failed to update profile", err);
                showSignupErrorToast(
                  t("manageProfile.toast.profileUpdateError")
                );
              }
            }}
          >
          ...
          <form
            ...
            onSubmit={async (e) => {
              ...
              try {
                ...
                showSignupSuccessToast(
                  t("manageProfile.toast.passwordUpdateSuccess")
                );
                setNewPassword("");
                setConfirmPassword("");
              } catch (err) {
                ...
                showSignupErrorToast(
                  t("manageProfile.toast.passwordUpdateError")
                );
              }
            }}
          >
